...
class TogaLayout(Layout[toga.Box]):
...
class TogaComponent(Component[toga.Box], Configurable, toga.Box):
...
class TogaStackedLayout[*Ts](StackedLayout[toga.Box, *Ts]):
    def __init__(self,
...
class TogaMultiLayoutApp(MultiLayoutApp[toga.Box], toga.App):

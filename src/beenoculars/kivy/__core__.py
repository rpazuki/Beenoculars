...
from beenoculars.config import Configurable
from beenoculars.core import Component, Layout, MultiLayoutApp, StackedLayout

log = logging.getLogger(__name__)


class KivyLayout(Layout[BoxLayout]):
...
class KivyComponent(Component[BoxLayout], Configurable, BoxLayout):
...
class KivyStackedLayout[*Ts](StackedLayout[BoxLayout, *Ts]):
...
class KivyMultiLayoutApp(MultiLayoutApp[BoxLayout], kivyApp):
